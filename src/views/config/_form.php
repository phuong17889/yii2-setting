    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <button type="button"
                        class="btn btn-success btn-add-new-custom-record"><?= Yii::t('setting', 'Add a new record') ?></button>
                <button type="button"
                        class="btn btn-primary btn-save-custom-record"><?= Yii::t('setting', 'Save changes') ?></button>
            </div>
        </div><!-- /.modal-content -->
    </div><!-- /.modal-dialog -->
</div><!-- /.modal -->
